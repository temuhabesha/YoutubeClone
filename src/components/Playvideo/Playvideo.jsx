...
const Playvideo = () => {
  ...
  const{videoId}=useParams();
    ...
    const fetchotherdata=async () => {
      ...
      const x=await fetch(comment_url).then(res=>res.json()).then(data=>setcommentdata(data.items));
  ...
  return (
    <div className='play-video'>
      ...
      <div className="vid-discription">
       <p>{apiData?apiData.snippet.description.slice(0,250):"Descriprion Here"}</p>
        <hr />
